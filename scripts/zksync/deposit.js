...
async function main() {
  ...
  const deposit = await soRandom.clientDeposit(signer.address, { value: ethers.utils.parseEther("0.0001") });
  await deposit.wait();

  console.log("deposited");

  console.log("New deposited balance:", await soRandom.clientBalanceOf(signer.address));
}
