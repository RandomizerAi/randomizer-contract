...
describe("Renew", function () {
  ...
  beforeEach(async function () {
    ...
    randomizer = await Randomizer.deploy(signers[0].address, signers[0].address, 3, "500000000000000000", 20, 900, 50000, 2000000, ethers.utils.parseEther("0.1"), [signers[1].address, signers[2].address, signers[3].address, signers[4].address, signers[5].address, signers[6].address]);
  ...
  it("slash stake of non-submitters and refund caller gas", async function () {
    ...
    const randomizer2 = await (await ethers.getContractFactory("RandomizerStatic")).deploy(ethers.constants.AddressZero, ethers.constants.AddressZero, 1, "500000000000000000", 50, 600, 50000, 2000000, ethers.utils.parseEther("0.00001"), [signers[0].address, signers[1].address, signers[2].address, signers[3].address, signers[4].address, signers[5].address]);
